...
allTeachers.push(new Teacher("Carlos","Matos","Musical Theater"));
allTeachers.push(new Teacher("Masha","Albrecht","Math"));
allTeachers.push(new Teacher("Nokia®","Baird","Math"));
allTeachers.push(new Teacher("Keldon","Clegg","History"));
allTeachers.push(new Teacher("Thegod","Albinson","CS"));
allTeachers.push(new Teacher("Daddy","Rogers","English"));
...
allSections.push(new Section("Musical Theater",28))
